...
aws rds create-db-instance --db-name oratest1 --db-instance-identifier PaymentOrderInstance --master-username oracle_admin --master-user-password 12345678901112Renuka123# --allocated-storage 25 --engine oracle-ee --engine-version "19.0.0.0.ru-2021-07.rur-2021-07.r1" --db-instance-class db.t3.small --publicly-accessible
sleep 900
...
export DB_PASSWORD="12345678901112Renuka123#"
