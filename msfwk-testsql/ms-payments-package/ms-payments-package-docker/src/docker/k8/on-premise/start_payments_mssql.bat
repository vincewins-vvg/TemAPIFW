...
SET db_Connection_Url=jdbc:sqlserver://paymentorder-db-service.payments.svc.cluster.local:1433;databaseName=payments
...
REM Description 	: Specifies the name of Images for api ,ingester, schemaregistry,scheduler,fileingester,mysql that are  pushed to external repositories,
...
REM Name 			: timeunit
REM Description		: Timeunit helps to organize and use time representations that will be maintained separately across various contexts.
REM Default Value	: MINUTES
REM Possible Values : MINUTES,SECONDS,HOURS,DAYS
...
REM SET dbinit_Connection_Url="jdbc:sqlserver://paymentorder-db-service.payments.svc.cluster.local:1433
