...
helm install appinit ./appinit -n appinitpayments --set env.sqlinit.databaseKey=sql --set env.sqlinit.databaseName=payments --set env.sqlinit.dbdialect=com.microsoft.sqlserver.jdbc.SQLServerDriver --set env.sqlinit.dbusername=sa --set env.sqlinit.dbpassword=Rootroot@12345 --set env.sqlinit.dbconnectionurl=jdbc:sqlserver://paymentorder-db-service.payments.svc.cluster.local:1433 --set env.sqlinit.dbdriver=com.mysql.jdbc.Driver --set env.sqlinit.dbautoupgrade=N
