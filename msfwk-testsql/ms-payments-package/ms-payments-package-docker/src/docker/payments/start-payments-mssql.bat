...
SET tag=DEV
REM Name         :api_Image,ingester_Image,schemaregistry_Image,scheduler_Image,fileingester_Image,mysql_Image
...
REM kubectl create namespace payments
