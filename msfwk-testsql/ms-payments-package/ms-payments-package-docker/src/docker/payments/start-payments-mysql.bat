...
helm install dbinit ./dbinit -n dbinitserviceorchestrator --set env.sqlinit.databaseKey=sql --set env.sqlinit.databaseName=ms_service_orchestrator --set env.sqlinit.dbdialect=org.hibernate.dialect.MySQL5InnoDBDialect --set env.sqlinit.dbusername=root --set env.sqlinit.dbpassword=password --set env.sqlinit.dbconnectionurl=jdbc:mysql://21.22.34.56:30107
