...
SET db_Connection_Url=jdbc:mysql://paymentorder-db-service:3007/payments

SET dbinit_Connection_Url=jdbc:mysql://paymentorder-db-service.payments.svc.cluster.local:3007/payments
...
SET schema_Registry_Url="http://a83cbc75d8fe648afa8e2a083caa3340-1789271741.eu-west-2.elb.amazonaws.com:8081"
...
REM uncomment below to push mysql image in ECR 
REM docker tag ms-paymentorder-mysql:latest %accountId%.dkr.ecr.eu-west-2.amazonaws.com/%repositoryname%:mysql
REM docker push %accountId%.dkr.ecr.eu-west-2.amazonaws.com/%repositoryname%:mysql
...
timeout /t 10 >nul
aws kinesis create-stream --stream-name paymentorder-outbox-topic --shard-count 1 
timeout /t 10 >nul
