...
export db_Connection_Url=jdbc:mysql://paymentorder-db-service:3007/payments
# Name 			  : min_Pool_Size
...
# uncomment below to push mysql image in ECR
...
#Uncomment the below to start the mysql db
# cd db/mysql
