...
export DB_MYSQL_IMAGE="ms-paymentorder-mysql:latest"
...
export EVENT_HUB_INBOX_TOPIC_PAYMENT_ORDER="paymentorder-inbox-topic"
...
export EVENT_HUB_OUTBOX_PAYMENT_TOPIC="ms-paymentorder-outbox"
export EVENT_HUB_OUTBOX_TOPIC="paymentorder-outbox-topic"
