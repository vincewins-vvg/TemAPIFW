...
az eventhubs eventhub create --name "${EVENT_HUB_INBOX_TOPIC_PAYMENT_ORDER}" --resource-group "${RESOURCE_GROUP_NAME}" --namespace-name "${EVENT_HUB_NAME_SPACE}"
...
az eventhubs eventhub create --name "${EVENT_HUB_OUTBOX_PAYMENT_TOPIC}" --resource-group "${RESOURCE_GROUP_NAME}" --namespace-name "${EVENT_HUB_NAME_SPACE}"

az eventhubs eventhub create --name "${EVENT_HUB_OUTBOX_TOPIC}" --resource-group "${RESOURCE_GROUP_NAME}" --namespace-name "${EVENT_HUB_NAME_SPACE}"
