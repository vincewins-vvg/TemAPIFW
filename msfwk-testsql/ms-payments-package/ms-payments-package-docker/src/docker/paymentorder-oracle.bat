...
REM jar uf %INGESTER_ENV_LOCATION%/ms-payments-ingester.jar -C %INGESTER_ENV_LOCATION% log4j2.properties
...
docker-compose -f kafka.yml -f paymentorder-oracle.yml %*
