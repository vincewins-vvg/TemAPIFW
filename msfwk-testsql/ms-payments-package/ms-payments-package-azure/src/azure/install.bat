...
SET EVENT_HUB_NAME_SPACE="posql-kafka"
...
SET SASL_JASS_CONFIG="org.apache.kafka.common.security.plain.PlainLoginModule required username=\"$ConnectionString\" password=\"Endpoint=sb://posql-kafka.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=yUoa/1dlVqghGSUhf3YWUH5v7sbz9stw5ozyk8MaCx8=\";"
...
SET KAFKA_SERVER="posql-kafka.servicebus.windows.net:9093"
...
SET INGESTER_APP_1="paymentinboxpinkavro"
...
rem Command to execute init scripts
