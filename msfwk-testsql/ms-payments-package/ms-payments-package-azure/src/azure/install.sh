...
# export GENERIC_INGESTER="com.temenos.microservice.framework.core.ingester.GenericCommandBinaryIngester"
export GENERIC_INGESTER="com.temenos.microservice.framework.core.ingester.MSKafkaOutboxEventListener"
