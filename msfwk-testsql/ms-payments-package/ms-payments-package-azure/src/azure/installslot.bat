...
SET RESOURCE_GROUP_NAME="MSF_2121_payments"
...
SET SRC_PATH="C:\KMB\Works\MSF-2122\frmwktestsuite\msfwk-testsql\ms-payments-package\ms-payments-package-azure\target\ms-payments-Azure\target\azure-functions\paymentsapp.zip"
...
SET DATABASE_NAME="paymentsstaging"
...
SET DB_CONNECTION_URL="jdbc:mysql://paymentsserver.mysql.database.azure.com:3306/paymentsstaging"
...
SET EVENT_HUB_NAME_SPACE="payments-Kafka-green"
