...
Scenario Outline: create Account using post method
	...
	Examples: 
        |payload|
		|{"accountId":"12", "accountName":"saving", "accountType":"sav", "branch":"ch"}|	
       
Scenario Outline: create Account of same unique ID

	When post the static MS JSON as payload <payload> 
	When a "POST" request is sent to MS 
	And log all MS response in console 
	Then MS response code should be 400 
	And MS JSON response string property key "message" should contain value "Could not be saved in Database"
