...
Scenario Outline: create customer of same unique ID
	...
	And MS JSON response string property key "message" should contain value "Mongodao operation exception while 'saveEntity' onE11000 duplicate key error collection: ms_paymentorder.ms_payment_order_customer index: customerId_1 dup key"
