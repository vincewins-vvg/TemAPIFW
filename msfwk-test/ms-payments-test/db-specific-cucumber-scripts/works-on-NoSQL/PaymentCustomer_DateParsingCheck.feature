#author:Mukila
Feature: PaymentCustomer_DateParsingCheck
...
Scenario: To check date parsing error in postgresql for Paymentcustomer api

#To insert the Payment reference details into the DB for testing purpose
Given enter the tablename ms_payment_order_customer
And enter data for table

      	| Fields | type | data|
		| dateOfJoining | stringd |1998-08-09T00:00:00.000Z|
		| customerName | string |Warner|
		| customerId | string |AD9898|

#getapi	
Scenario Outline: to retrieve a customer using query param-from and todate
	

	And MS query parameter "fromDate" is set to value "1998-08-08" 
	And MS query parameter "toDate" is set to value "1998-08-09" 
	...
	Examples: 
		...
		|response|
		|[{"customerId":"AD9898","customerName":"Warner","dateOfJoining":"1998-08-09"}]|
