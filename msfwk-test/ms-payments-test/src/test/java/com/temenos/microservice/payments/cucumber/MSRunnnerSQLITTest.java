...
@CucumberOptions(junit = "--no-step-notifications",monochrome = true , features = {"cucumber-test-scripts/","db-specific-cucumber-scripts/works-on-SQL/","error-topic-scripts/error-topic-apis/","health-check-scripts/health-check/","Gdpr-scripts/Works-On-SQL/"}, glue = {
...
public class MSRunnnerSQLITTest {
