...
public class IngesterITTest {
	...
	private static String getIFDataEvent() {
		return new DynamicArrayBuilder(MARKER).value("1544").fm(4).value("PAYMENT.ORDER").fm().value("abc~123~zyz").fm()
				.lfm(9).value("12121").lfm(5).value("IngesterTest").lfm(3).value("52521").lfm(47).value("USF").lfm(4)
