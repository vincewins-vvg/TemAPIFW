...
@CucumberOptions(junit = "--no-step-notifications",monochrome = true , features = {"Gdpr-scripts/Works-On-NOSQL/","cucumber-test-scripts/","db-specific-cucumber-scripts/works-on-NoSQL/"}, glue = {
