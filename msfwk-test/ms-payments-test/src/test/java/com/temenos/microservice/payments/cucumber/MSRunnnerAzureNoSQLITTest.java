...
@CucumberOptions(junit = "--no-step-notifications",monochrome = true , features = { "cucumber-test-scripts/","db-specific-cucumber-scripts/works-on-NoSQL/","Gdpr-scripts/Works-On-NOSQL/"}, glue = {
