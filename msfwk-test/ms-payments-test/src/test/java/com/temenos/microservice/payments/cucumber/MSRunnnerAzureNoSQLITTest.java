...
@CucumberOptions(junit = "--no-step-notifications",monochrome = true , features = { "cucumber-test-scripts/","db-specific-cucumber-scripts/works-on-NoSQL/","Gdpr-scripts/Works-On-NOSQL/Report_Generation/","Gdpr-scripts/Works-On-NOSQL/Erasure/" }, glue = {
...
public class MSRunnnerAzureNoSQLITTest {
