...
@CucumberOptions(junit = "--no-step-notifications",monochrome = true , features = { "cucumber-test-scripts/","db-specific-cucumber-scripts/works-on-SQL/","Gdpr-scripts/Works-On-SQL/Report_Generation/","Gdpr-scripts/Works-On-SQL/Erasure/" }, glue = {
