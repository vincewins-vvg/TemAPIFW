...
@CucumberOptions(junit = "--no-step-notifications",monochrome = true , features = { "cucumber-test-scripts/","db-specific-cucumber-scripts/works-on-SQL/AutoGenEmployee.feature","db-specific-cucumber-scripts/works-on-SQL/CRUDOps_AutoGenEmployee.feature"}, glue = {
...
public class MSRunnnerAzureSQLITTest {
