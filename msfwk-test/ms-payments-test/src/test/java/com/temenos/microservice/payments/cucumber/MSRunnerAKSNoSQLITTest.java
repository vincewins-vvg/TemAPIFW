...
@CucumberOptions(junit = "--no-step-notifications",monochrome = true , features = {"db-specific-cucumber-scripts/works-on-NoSQL/","Gdpr-scripts/Works-On-NOSQL/","cucumber-test-scripts/multi-part-scenarios/","cucumber-test-scripts/response-pagination/","cucumber-test-scripts/inbox-outbox-for-api/"}, glue = {
...
public class MSRunnerAKSNoSQLITTest {
