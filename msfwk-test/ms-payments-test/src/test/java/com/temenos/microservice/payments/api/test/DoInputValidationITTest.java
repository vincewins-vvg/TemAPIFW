...
public class DoInputValidationITTest extends ITTest {
	...
	public void testInpuValidationExtensionDataNull() {
		...
		assertTrue(createResponse.bodyToMono(String.class).block().contains("[{\"message\":\"[PaymentDetails.extensionData must not be null]\",\"code\":\"\"}]"));
	}
	@Test
	public void testInpuValidationObjectNull() {
		...
		assertTrue(createResponse.statusCode().equals(HttpStatus.BAD_REQUEST));
		assertTrue(createResponse.bodyToMono(String.class).block().contains("[{\"message\":\"[PaymentDetails.PaymentOrdersItems must not be null]\",\"code\":\"\"}]"));
	}
	@Test
	public void testInpuValidationArrayNull() {
		...
		assertTrue(createResponse.statusCode().equals(HttpStatus.BAD_REQUEST));
		assertTrue(createResponse.bodyToMono(String.class).block().contains("[{\"message\":\"[PaymentDetails.paymentOrders must not be null]\",\"code\":\"\"}]"));
	}
	@Test
	public void testInpuValidationEnumNull() {
		...
		assertTrue(createResponse.statusCode().equals(HttpStatus.BAD_REQUEST));
		assertTrue(createResponse.bodyToMono(String.class).block().contains("[{\"message\":\"[PaymentDetails.currency must not be null]\",\"code\":\"\"}]"));
	}
	@Test
	public void testInpuValidationtTimeStampNull() {
		...
		assertTrue(createResponse.statusCode().equals(HttpStatus.BAD_REQUEST));
		assertTrue(createResponse.bodyToMono(String.class).block().contains("[{\"message\":\"[PaymentDetails.paymentDate must not be null]\",\"code\":\"\"}]"));
	}
	@Test
	public void testInpuValidationtUuidNull() {
		...
		assertTrue(createResponse.statusCode().equals(HttpStatus.BAD_REQUEST));
		assertTrue(createResponse.bodyToMono(String.class).block().contains("[{\"message\":\"[PaymentDetails.socialSecurityNo must not be null]\",\"code\":\"\"}]"));
	}
	@Test
	public void testInpuValidationtByteBufferNull() {
		...
		assertTrue(createResponse.statusCode().equals(HttpStatus.BAD_REQUEST));
		assertTrue(createResponse.bodyToMono(String.class).block().contains("[{\"message\":\"[PaymentDetails.fileReadWrite must not be null]\",\"code\":\"\"}]"));
	}
	@Test
	public void testInpuValidationtNumberNull() {
		...
		assertTrue(createResponse.statusCode().equals(HttpStatus.BAD_REQUEST));
		assertTrue(createResponse.bodyToMono(String.class).block().contains("[{\"message\":\"[PaymentDetails.paymentId must not be null, PaymentDetails.branchId must not be null, PaymentDetails.monthCount must not be null, PaymentDetails.yearWiseInterest must not be null]\",\"code\":\"\"}]"));
	}
	@Test
	public void testInpuValidationtNumberMIN() {
		...
		assertTrue(createResponse.statusCode().equals(HttpStatus.BAD_REQUEST));
		assertTrue(createResponse.bodyToMono(String.class).block().contains("[{\"message\":\"[PaymentDetails.personalAccNo must be greater than or equal to 5, PaymentDetails.branchId must be greater than or equal to 5, PaymentDetails.penaltyInterest must be greater than or equal to 5, PaymentDetails.yearWiseInterest must be greater than or equal to 1.0]\",\"code\":\"\"}]"));
	}
	@Test
	public void testInpuValidationtNumberMAX() {
		...
		assertTrue(createResponse.statusCode().equals(HttpStatus.BAD_REQUEST));
		assertTrue(createResponse.bodyToMono(String.class).block().contains("[{\"message\":\"[PaymentDetails.personalAccNo must be lesser than or equal to 50, PaymentDetails.branchId must be lesser than or equal to 50, PaymentDetails.penaltyInterest must be lesser than or equal to 50, PaymentDetails.yearWiseInterest must be lesser than or equal to 60.0]\",\"code\":\"\"}]"));
	}
	@Test
	public void testInpuValidationtStringNull() {
		...
		assertTrue(createResponse.statusCode().equals(HttpStatus.BAD_REQUEST));
		assertTrue(createResponse.bodyToMono(String.class).block().contains("[{\"message\":\"[PaymentDetails.paymentMethod must not be null]\",\"code\":\"\"}]"));
	}
}