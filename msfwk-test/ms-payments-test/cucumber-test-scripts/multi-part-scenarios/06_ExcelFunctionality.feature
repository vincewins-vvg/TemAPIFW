 #BalajiLakshmiNarayanan
  ...
  Background: To set the preconfig for the scenarios
    ...
    Scenario: To upload a Excel file
    ...
    #And MS request form-data "documentDetails" is set to "{"documentId":"66","documentName":"Excel File"}"
    #And upload document with key "textDoc" from file path "src/test/resources/cucumber-json-payload/SampleExcel.xlsm"
    ...
    Scenario: To download the Excel file and check its size
    
    #And MS request URI is "v1.0.0/payments/download/SampleExcel.xlsm"
    #And create a new MS request with code using Restassured arguments "FILEDOWNLOAD"
    #When a "GET" request is sent to MS
    #Then MS response code should be 200
    #Then check if file download is successful and size is equal to file uploaded from file path "src/test/resources/cucumber-json-payload/SampleExcel.xlsm"
    #And log all MS response in console
