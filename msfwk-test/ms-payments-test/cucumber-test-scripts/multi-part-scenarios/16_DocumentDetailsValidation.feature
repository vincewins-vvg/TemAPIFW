 #BalajiLakshmiNarayanan
  ...
  Feature: 16_DocumentDetailsValidation
  ...
  Background: To set the preconfig for the scenarios
    ...
    Scenario: To upload a file without documentDetails
    ...
    Scenario: To upload a file with junk documentDetails
    ...
    Scenario: To upload a file without documentId in documentDetails
    ...
    Scenario: To upload a file without documentName in documentDetails
