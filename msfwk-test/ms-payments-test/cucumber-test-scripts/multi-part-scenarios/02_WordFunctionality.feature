 #BalajiLakshmiNarayanan
  ...
  Feature: 02_FileUploadWordFunctionality
  ...
  Background: To set the preconfig for the scenarios
    ...
    Scenario: To upload a word file
    ...
    Then MS response code should be 200
    Then check if file download is successful and size is equal to file uploaded from file path "src/test/resources/cucumber-json-payload/TestWord1.docx"
    And log all MS response in console
