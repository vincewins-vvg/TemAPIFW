...
#To create PO details in order to validate against nullable checks - Null values passed as part of the JSON.
	...
	Examples: 
		|payload|
		|{"fromAccount":"1824","toAccount":"1721","PaymentReferenceTestData":"PayRefTestData","paymentDetails":"TEST","currency":"USD","amount":100,"expires":0,"fileContent":"dGVzdA==","paymentMethod":{"id":1,"name":"TT"}}|