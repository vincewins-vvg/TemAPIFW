Feature: CreatePaymentReference
  ...
  Scenario Outline: Create a new reference detail
  ...
  #To insert the Payment reference details into the DB for testing purpose
	...
	Examples:
    |payload|
    |{"references":{"PaymentReference":[{"value":"PayRefTest","description":"PayRefTestDescription"}]}}|