...
Scenario Outline: Post method for nullclass handling
  ...
  | description | string |Payment ref|
    ...
    And MS request URI is "v1.0.0/payments/validate"
    ...
    Examples: 
		|payload|response|
		|{"fromAccount":"1824","toAccount":"1721","PaymentReference":"paytest1","paymentDetails":"TEST","currency":"USD","amount":100,"expires":0,"fileContent":"TEST","paymentMethod":{"id":1,"name":"TT"}}|[{"message":"Either temn.msf.function.class.CreateValidateRequest or className_CreateValidateRequest environment property not Configured","code":"MSF-500"}]|
