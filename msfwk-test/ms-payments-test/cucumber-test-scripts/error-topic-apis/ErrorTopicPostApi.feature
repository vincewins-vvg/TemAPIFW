...
Feature: ErrorTopicPostApi
  ...
  #Scenario Outline:: To validate the error top post api 
   #Given create a new MS request with code using Restassured arguments "GET_PAYMENTODER_AUTH_CODE"
    ...
    #And set bundle "a2" with session property string "items[0].eventId"  
  
    #Given create a new MS request with code "GET_PAYMENTODER_AUTH_CODE"
    #And set the request path as "v1.0.0/system/ingester/errorDetail/services?status=UNPROCESSED"
    #And set the request payload from file "/jsonpayloadinputtemplate/createconfig.json"
    ...
    #Then property "items(0)/errorMessage" should be equal to string "Error Message = Unable to update the entity,Error Code = MSF-999"
    #And set bundle "a2" with session property string "items(0)/eventId"  
#
#
#Given create a new MS request with code "GET_PAYMENTODER_AUTH_CODE"
    ...
    #And set bundle "a2" with session property string "items(0)/eventId"  
    #Actual Post
# Scenario Outline: Actual Post Error Api
  #
   ...
   #
    ...
    #And log all MS response in console
    #Then MS response code should be 200
    #Then property "eventIds(0)" should be equal to string "a2"
