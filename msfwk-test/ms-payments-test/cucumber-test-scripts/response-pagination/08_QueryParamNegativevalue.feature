Feature: 08_QueryParamNegativevalue
  ...
  Scenario: To check Pv1.0.0/O GET API for pagination with page number query parameter equals negative value and valid value in page size

    And MS query parameter "pageNumber" is set to numeric value "-1"
    And MS query parameter "pageSize" is set to value "2"
    When a "GET" request is sent to MS
    And log all MS response in console
    Then MS response code should be 200
    Then MS JSON property "items" should contain at most 2 elements

   
   
  Scenario: To check PO GET API for pagination with page size query parameter equals negative value and valid value in page number
    
    And MS query parameter "pageNumber" is set to value "1"
    And MS query parameter "pageSize" is set to numeric value "-1"
    When a "GET" request is sent to MS
    And log all MS response in console
    Then MS response code should be 200
  ...
  Scenario: To check PO GET API for pagination with both page number and page size having equals negative value
