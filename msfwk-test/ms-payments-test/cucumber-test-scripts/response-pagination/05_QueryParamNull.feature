Feature: 05_QueryParamNull
  ...
  Scenario: To check PO GET API for pagination with page number query parameter equals null

    And MS query parameter "pageNumber" is set to value "null"
  ...
  Scenario: To check PO GET API for pagination with page size query parameter equals null
    
    And MS query parameter "pageNumber" is set to value "1"
    And MS query parameter "pageSize" is set to value "null"
