Feature: CreateReferenceDetailsPaymentOrder

#In this scenario we get the values using GET Method that is already available in the DB.
#Sequence: CreateReference Data >> UpdateReference for the created data >> Get the updated data 
...
#To insert the Payment reference details into the DB for testing purpose
	...
	Examples: 
		|payload|
		| {"references":{"testreference1":[{"value":"Married","description":"Married"}],"testreference2":[{"value":"Male","description":"Male"}]}}|
