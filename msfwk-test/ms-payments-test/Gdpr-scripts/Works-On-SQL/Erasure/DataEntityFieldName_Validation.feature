Feature: DataEntityFieldName_Validation
  ...
  | description | string |Payment ref|
   ...
   #DataEntityFieldName validation 
    ...
    And MS JSON response string property key "message" should contain value "[Method not foundcom.temenos.microservice.payments.entity.ExchangeRate.getCurrency-com.temenos.microservice.payments.entity.ExchangeRate.getCurrency()]"
  ...
  Scenario Outline: DataEntityFieldName validation with invalid name in last element
    ...
    And log all MS response in console
    Then MS response code should be 400
    And MS JSON response string property key "message" should contain value "[Method not foundcom.temenos.microservice.payments.entity.Card.getAmount-com.temenos.microservice.payments.entity.Card.getAmount()]" 
    And MS JSON response string property key "code" should equal value "[MSF-703]"
