Feature: AllFormatErasure_Validation
  ...
  | description | string |Payment ref|
	...
	And the MS request body is set to the contents of "src/test/resources/cucumber-json-payload/GDPR/SQL/CreatePOWithExtensionData_Erasure1.json"
   ...
   # AllFormatErasure_Validation
    ...
    And create a new MS request with code using Restassured arguments "CREATE_PAYMENTORDER_AUTH_CODE"
    And the MS request body is set to the contents of "src/test/resources/cucumber-json-payload/GDPR/SQL/Erasure1.json"
    ...
    And MS JSON response string property key "customerId" should equal value "PO~352-ER8~321-ZXC~INR~125"
    ...
    And Validate the below details from the db table ms_payment_order and check no of record is 1
      ...
      #| MS-Test-ER-20    | paymentDate      | 9999-12-31 00:00:00 |
...
#And Validate the below details from the db table card and check no of record is 1
    ...
    And create a new MS request with code using Restassured arguments "CREATE_PAYMENTORDER_AUTH_CODE"
    And the MS request body is set to the contents of "src/test/resources/cucumber-json-payload/GDPR/SQL/Report1.json"
    When a "PUT" request is sent to MS
    And log all MS response in console
    Then MS response code should be 200
    And check full response with expected json content from file path "src/test/resources/cucumber-json-payload/GDPR/SQL/ReportResult1.json"
