Feature: ListOfErrorResponses
  ...
  | value | string |paytestsqlresponse1|
 ...
 Scenario Outline: Resolving the above entity impl errors to view the error responses for entityfieldname
  ...
  Scenario Outline: Resolving  entity field impl errors for positive response
    ...
    And MS JSON response string property key "customerId" should equal value "PO~352-LOES1~123-ABC~USD~485"
    And MS JSON response string property key "erasureRequestId" should equal value "126.sqlresponse"
