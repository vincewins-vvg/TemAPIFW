...
#(MFW-2949)
 ...
 #Invalid PO id that is not present in db
    ...
    And MS JSON response string property key "customerId" should equal value "PO~346-RH8888~123-ABC~USD~485"
    ...
    Examples: 
         |payload|
         |{"partyId":"test","customerId":"PO~346-RH8888~123-ABC~USD~485","serviceId":"PARTY","customEntityidentifier":{"amount":"111"},"personalData":[{"purpose":"tax","dataDefinitions":[{"dataEntityName":"PaymentOrder","dataEntityFields":[{"dataEntityFieldName":"currency1","dataEntityFieldDataType":"string","erasureOptions":{"optionsId":"ALPHA","optionsValue":"P"}}]}]},{"purpose":"tax1","dataDefinitions":[{"dataEntityName":"PaymentOrder","dataEntityFields":[{"dataEntityFieldName":"amount","dataEntityFieldDataType":"decimal","erasureOptions":{"optionsId":"NULLIFY","optionsValue":"A1"}}]}]}]}|
         
  Scenario Outline: Retrieving the above invalid PO id to check any erasure takes place
    
    And Set the Testcase id MS-Test-RH-007 for company GB0010001
    And MS request URI is "v1.0.0/party/personalData/reports/SAR/requests/117.LSRECORD"
    And post the static MS JSON as payload <payload> 
    When a "PUT" request is sent to MS
    And log all MS response in console
    Then MS response code should be 200
    ...
    And Set the Testcase id MS-Test-RH-007 for company GB0010001
    And MS request URI is "v1.0.0/party/personalData/reports/SAR/requests/118.LSRECORD"
    And post the static MS JSON as payload <payload> 
    When a "PUT" request is sent to MS
    And log all MS response in console
    ...
    And MS JSON response string property key "requestId" should equal value "[118.LSRECORD]"
    And MS JSON response string property key "reportType" should equal value "[SAR]"
      
    Examples: 
         |payload|
         |{"partyId":"678911","customerId":"PO~346-RH8888~123-ABC~USD~485","serviceId":"PARTY","customEntityidentifier":{"fromAccount":"150-IOB","toAccount":"334-IOB","paymentDetails":"doc","currency":"INR"},"personalData":[{"dataEntityName":"PaymentOrder","dataEntityFields":[{"dataEntityFieldName":"paymentDate","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"amount","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"paymentDetails","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"paymentReference","dataEntityFieldDataType":"string"}]},{"dataEntityName":"PaymentOrder.paymentMethod.card1","dataEntityFields":[{"dataEntityFieldName":"cardname","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"cardlimit","dataEntityFieldDataType":"string"}]},{"dataEntityName":"PaymentOrder.exchangeRates23","dataEntityFields":[{"dataEntityFieldName":"name","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"value","dataEntityFieldDataType":"string"}]},{"dataEntityName":"PaymentOrder12","dataEntityFields":[{"dataEntityFieldName":"currency12","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"status","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"paymentDate","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"debitAccount","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"creditAccount","dataEntityFieldDataType":"string"}]},{"dataEntityName":"PaymentOrder.payeeDetails","dataEntityFields":[{"dataEntityFieldName":"payeeName","dataEntityFieldDataType":"decimal"},{"dataEntityFieldName":"payeeType","dataEntityFieldDataType":"decimal"}]},{"dataEntityName":"PaymentOrder.PaymentMethod","dataEntityFields":[{"dataEntityFieldName":"name","dataEntityFieldDataType":"decimal"}]}]}|        
