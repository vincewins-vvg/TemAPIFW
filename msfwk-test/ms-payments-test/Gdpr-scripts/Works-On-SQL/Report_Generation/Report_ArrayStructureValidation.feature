Feature: Report_ArrayStructureValidation
  ...
  | description | string |Payment ref|
   ...
   #DataEntity field array  validation 
    ...
    And MS JSON response string property key "customerId[0]" should equal value "PO~351-RG7~123-ABC~USD~485"
    ...
    And MS JSON response string property key "customerId[1]" should equal value "PO~351-RG7~123-ABC~USD~485"
    ...
    Examples: 
         |payload|
         |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"PO~351-RG7~123-ABC~USD~485","serviceId":"PARTY","customEntityidentifier":{"fromAccount":"150-IOB","toAccount":"334-IOB","paymentDetails":"doc","currency":"INR"},"personalData":[{"dataEntityName":"PaymentOrder","dataEntityFields":[{}]}]}|
    ...
    And MS JSON response string property key "customerId" should equal value "PO~351-RG7~123-ABC~USD~485"
 ...
 Scenario Outline: Without DataEntity field array validation in payload
   ...
   Examples: 
         |payload|
         |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"PO~351-RG7~123-ABC~USD~485","serviceId":"PARTY","customEntityidentifier":{"fromAccount":"150-IOB","toAccount":"334-IOB","paymentDetails":"doc","currency":"INR"},"personalData":[{"dataEntityName":"PaymentOrder"}]}|
 ...
 Scenario Outline: Personal data array validation with empty array element
   ...
   And Set the Testcase id MS-Test-RG-023 for company GB0010001
    ...
    Examples: 
         |payload|
         |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"PO~351-RG7~123-ABC~USD~485","serviceId":"PARTY","customEntityidentifier":{"fromAccount":"150-IOB","toAccount":"334-IOB","paymentDetails":"doc","currency":"INR"},"personalData":[{}]}|
...
Scenario Outline: Personal data array validation with empty array
 ...
 Scenario Outline: Without Personal data array in payload
  ...
  Examples: 
         |payload|
         |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"PO~351-RG7~123-ABC~USD~485","serviceId":"PARTY","customEntityidentifier":{"fromAccount":"150-IOB","toAccount":"334-IOB","paymentDetails":"doc","currency":"INR"}}|
