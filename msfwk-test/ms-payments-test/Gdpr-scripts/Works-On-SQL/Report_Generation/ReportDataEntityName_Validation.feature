Feature: ReportDataEntityName_Validation
  ...
  | description | string |Payment ref|
   ...
   #DataEntityName validation 
    ...
    And MS JSON response string property key "customerId" should equal value "[PO~347-RG3~123-ABC~USD~485]"
