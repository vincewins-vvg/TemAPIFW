Feature: Report_DataEntityFieldNameValidation
  ...
  | description | string |Payment ref|
   ...
   #DataEntityFieldName validation 
    ...
    And MS JSON response string property key "message" should contain value "[Method not foundcom.temenos.microservice.payments.entity.Card.getPayeeType-com.temenos.microservice.payments.entity.Card.getPayeeType()]"
  ...
  Scenario Outline: DataEntityFieldName validation with invalid name in last element
    ...
    And log all MS response in console
    Then MS response code should be 400
    And MS JSON response string property key "message" should contain value "[Method not foundcom.temenos.microservice.payments.entity.ExchangeRate.getPayeeType-com.temenos.microservice.payments.entity.ExchangeRate.getPayeeType()]" 
    And MS JSON response string property key "code" should equal value "[MSF-703]"
