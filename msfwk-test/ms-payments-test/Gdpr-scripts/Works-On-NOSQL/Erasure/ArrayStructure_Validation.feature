Feature: ArrayStructure_Validation
  ...
  Scenario Outline: create customer using post method
	...
	And MS JSON response string property key "customerId" should equal value "ER7"
	And MS JSON response string property key "status" should equal value "Created"

Examples: 
        |payload|
		|{"customerId":"ER7","customerName":"Riya","account":"351-ER7","loanTypes":["education loan"],"dateOfJoining":"2020-08-26"}|
  ...
  | description | string |Payment ref|
   ...
   #DataEntity field array  validation 
    ...
    Examples: 
         |payload|
         |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"ER7","serviceId":"PARTY","customEntityidentifier":{"amount":"111"},"personalData":[{"purpose":"tax","dataDefinitions":[{"dataEntityName":"PaymentOrder.paymentMethod","dataEntityFields":[{}]}]}]}|
    ...
    And MS JSON response string property key "message" should equal value "[Entity Field Name or Field Type should not be empty]"
    And MS JSON response string property key "code" should equal value "[MSF-701]"

    Examples: 
         |payload|
         |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"ER7","serviceId":"PARTY","customEntityidentifier":{"amount":"111"},"personalData":[{"purpose":"tax","dataDefinitions":[{"dataEntityName":"PaymentOrder","dataEntityFields":[]}]}]}|
 ...
 Scenario Outline: Without DataEntity field array validation in payload
    ...
    And log all MS response in console
    Then MS response code should be 400
    And MS JSON response string property key "message" should equal value "[Entity Field Name or Field Type should not be null]"
    And MS JSON response string property key "code" should equal value "[MSF-701]"

    Examples: 
         |payload|
         |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"ER7","serviceId":"PARTY","customEntityidentifier":{"amount":"111"},"personalData":[{"purpose":"tax","dataDefinitions":[{"dataEntityName":"PaymentOrder.exchangeRates"}]}]}|
 ...
 Scenario Outline: DataDefinition array validation with empty array element
   ...
   And Set the Testcase id MS-Test-ER-011 for company GB0010001
    ...
    Examples: 
         |payload|
         |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"ER7","serviceId":"PARTY","customEntityidentifier":{"amount":"111"},"personalData":[{"purpose":"tax","dataDefinitions":[{}]}]}]}|
 ...
 Scenario Outline: Personal data array validation with empty array element
   ...
   And Set the Testcase id MS-Test-ER-013 for company GB0010001
    ...
    And log all MS response in console
    Then MS response code should be 400
    And MS JSON response string property key "message" should equal value "[DataDefinitions should not be null]"
    And MS JSON response string property key "code" should equal value "[MSF-701]"
    #And set timeout session for 60 seconds
    
    Examples: 
         |payload|
         |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"ER7","serviceId":"PARTY","customEntityidentifier":{"amount":"111"},"personalData":[{}]}|
...
Scenario Outline: Personal data array validation with empty array
 ...
 Scenario Outline: Without Personal data array in payload
    ...
    Examples: 
         |payload|
         |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"ER7","serviceId":"PARTY","customEntityidentifier":{"amount":"111"}}|
