...
Examples: 
  ...
  | description | string |Payment ref|
   ...
   #DataEntity field array  validation 
    ...
    And MS JSON response string property key "customerId[0]" should equal value "ER7"
    ...
    And MS JSON response string property key "customerId[1]" should equal value "ER7"
