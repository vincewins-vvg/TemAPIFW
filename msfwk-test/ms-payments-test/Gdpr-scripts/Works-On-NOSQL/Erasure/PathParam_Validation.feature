Feature: PathParam_Validation
  ...
  Scenario Outline: create customer using post method
	...
	And MS JSON response string property key "customerId" should equal value "ER1"
	And MS JSON response string property key "status" should equal value "Created"

Examples: 
        |payload|
		|{"customerId":"ER1","customerName":"Riya","account":"345-ER1","loanTypes":["education loan"],"dateOfJoining":"2020-08-26"}|
  ...
  | description | string |Payment ref|
   ...
   #Path param validation for erasure id
    ...
    Examples: 
         |payload|
         |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"ER1","serviceId":"PARTY","customEntityidentifier":{"amount":"111"},"personalData":[{"purpose":"tax","dataDefinitions":[{"dataEntityName":"PaymentOrder","dataEntityFields":[{"dataEntityFieldName":"paymentDetails","dataEntityFieldDataType":"string","erasureOptions":{"optionsId":"ALPHA","optionsValue":"P"}}]}]}]}|
   ...
   #Path param validation for erasure id
    ...
    Examples: 
    |payload|
   |{"partyId":"PO~DATEST~CADEST~USD~100","customerId":"ER1","serviceId":"PARTY","customEntityidentifier":{"amount":"111"},"personalData":[{"purpose":"tax","dataDefinitions":[{"dataEntityName":"PaymentOrder","dataEntityFields":[{"dataEntityFieldName":"currency","dataEntityFieldDataType":"string","erasureOptions":{"optionsId":"ALPHA","optionsValue":"P"}}]}]}]}|
