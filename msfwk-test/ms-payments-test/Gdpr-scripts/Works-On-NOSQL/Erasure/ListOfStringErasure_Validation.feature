...
Scenario: to retrieve a customer using query param account to check the loan types
  ...
  Examples: 
    ...
    Then MS response code should be 200
    And MS JSON property "partyId" should exist
    And MS JSON property "requestId" should exist
    And MS JSON property "serviceId" should exist
    ...
    And MS JSON response string property key "customerId" should equal value "LS1"
     ...
     Examples: 
         |payload||response|
         |{"partyId":"205761453936","customerId":"LS1","serviceId":"PARTY","customEntityidentifier":{"currency":"INR"},"personalData":[{"dataEntityName":"Customer","dataEntityFields":[{"dataEntityFieldName":"customerId","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"customerName","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"account","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"loanTypes","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"dateOfJoining","dataEntityFieldDataType":"string"}]}]}||{"partyId":"205761453936","customerId":"LS1","serviceId":"PARTY","requestId":"111.LSERASURE","reportType":"SAR","personalData":[{"dataEntityName":"Customer","dataEntityFields":[{"attributeName":"customerId","attributeValue":"LS1"},{"attributeName":"customerName","attributeValue":"Riya"},{"attributeName":"account","attributeValue":"352-LS1"},{"attributeName":"loanTypes","attributeValue":"[]"},{"attributeName":"dateOfJoining","attributeValue":"9999-12-31"}]}]}|
...
Scenario: to retrieve a customer using query param account to check the loan types
  ...
  Examples: 
    ...
    And MS JSON response string property key "customerId" should equal value "LS2"
     ...
     Examples: 
         |payload||response|
         |{"partyId":"205761453936","customerId":"LS2","serviceId":"PARTY","customEntityidentifier":{"currency":"INR"},"personalData":[{"dataEntityName":"Customer","dataEntityFields":[{"dataEntityFieldName":"customerId","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"customerName","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"account","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"loanTypes","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"dateOfJoining","dataEntityFieldDataType":"string"}]}]}||{"partyId":"205761453936","customerId":"LS2","serviceId":"PARTY","requestId":"112.LSERASURE","reportType":"SAR","personalData":[{"dataEntityName":"Customer","dataEntityFields":[{"attributeName":"customerId","attributeValue":"LS2"},{"attributeName":"customerName","attributeValue":"Riya"},{"attributeName":"account","attributeValue":"352-LS2"},{"attributeName":"loanTypes","attributeValue":"[]"},{"attributeName":"dateOfJoining","attributeValue":"9999-12-31"}]}]}|
...
Scenario Outline: Nullifying the above created entry with option value for nullify(here it doesnt consider the erasure options for list of string)
  ...
  Examples: 
     ...
     # Retrieve after erasure_Validation
    Scenario Outline: Retrieve the above nullified entry
    ...
    And MS JSON response string property key "customerId" should equal value "LS3"
     ...
     Examples: 
         |payload||response|
         |{"partyId":"205761453936","customerId":"LS3","serviceId":"PARTY","customEntityidentifier":{"currency":"INR"},"personalData":[{"dataEntityName":"Customer","dataEntityFields":[{"dataEntityFieldName":"customerId","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"customerName","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"account","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"loanTypes","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"dateOfJoining","dataEntityFieldDataType":"string"}]}]}||{"partyId":"205761453936","customerId":"LS3","serviceId":"PARTY","requestId":"113.LSERASURE","reportType":"SAR","personalData":[{"dataEntityName":"Customer","dataEntityFields":[{"attributeName":"customerId","attributeValue":"LS3"},{"attributeName":"customerName","attributeValue":"Riya"},{"attributeName":"account","attributeValue":"352-LS3"},{"attributeName":"loanTypes","attributeValue":"[]"},{"attributeName":"dateOfJoining","attributeValue":"9999-12-31"}]}]}|
...
Scenario: to retrieve a customer using query param account to check the loan types
  ...
  Examples: 
    ...
    And MS JSON response string property key "customerId" should equal value "LS4"
     ...
     Examples: 
         |payload||response|
         |{"partyId":"205761453936","customerId":"LS4","serviceId":"PARTY","customEntityidentifier":{"currency":"INR"},"personalData":[{"dataEntityName":"Customer","dataEntityFields":[{"dataEntityFieldName":"customerId","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"customerName","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"account","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"loanTypes","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"dateOfJoining","dataEntityFieldDataType":"string"}]}]}||{"partyId":"205761453936","customerId":"LS4","serviceId":"PARTY","requestId":"111.LSERASURE","reportType":"SAR","personalData":[{"dataEntityName":"Customer","dataEntityFields":[{"attributeName":"customerId","attributeValue":"LS4"},{"attributeName":"customerName","attributeValue":"Riya"},{"attributeName":"account","attributeValue":"352-LS4"},{"attributeName":"loanTypes","attributeValue":"[]"},{"attributeName":"dateOfJoining","attributeValue":"9999-12-31"}]}]}|
