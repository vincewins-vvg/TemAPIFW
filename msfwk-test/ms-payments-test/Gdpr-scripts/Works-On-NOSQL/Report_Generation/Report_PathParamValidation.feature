  ...
  | description | string |Payment ref|
   ...
   #Path param validation for request id
    ...
    And MS JSON response string property key "statusCode" should equal value "200"  
     ...
     Examples: 
    |payload||repsonse|
    |{"partyId":"2057614539311","customerId":"RG1","serviceId":"PARTY","customEntityidentifier":{"fromAccount":"150-IOB","toAccount":"334-IOB","paymentDetails":"doc","currency":"INR"},"personalData":[{"dataEntityName":"PaymentOrder.paymentMethod.card","dataEntityFields":[{"dataEntityFieldName":"cardname","dataEntityFieldDataType":"string"},{"dataEntityFieldName":"cardlimit","dataEntityFieldDataType":"string"}]}]}||{"partyId":"2057614539311","customerId":"RG1","serviceId":"PARTY","requestId":"**@@@","reportType":"SAR","statusCode":"200","personalData":[{"dataEntityName":"PaymentOrder.paymentMethod.card", "entityId": "PO~345-RG1~123-ABC~USD~485","dataEntityFields":[{"attributeName":"cardname","attributeValue":"allwin"},{"attributeName":"cardlimit","attributeValue":"1.11"}]}]}|
