Feature: Report_DataEntityFieldTypeValidation
  ...
  Scenario Outline: create customer using post method
	...
	And MS JSON response string property key "customerId" should equal value "RG5"
	And MS JSON response string property key "status" should equal value "Created"

Examples: 
        |payload|
		|{"customerId":"RG5","customerName":"Riya","account":"349-RG5","loanTypes":["education loan"],"dateOfJoining":"2020-08-26"}|
