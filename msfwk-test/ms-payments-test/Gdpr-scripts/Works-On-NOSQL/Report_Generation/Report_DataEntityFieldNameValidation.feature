...
Examples: 
  ...
  | description | string |Payment ref|
   ...
   #DataEntityFieldName validation 
    ...
    And MS JSON response string property key "errorMessage" should contain value "[Method not foundcom.temenos.microservice.paymentorder.entity.Card.getPayeeType-com.temenos.microservice.paymentorder.entity.Card.getPayeeType()]"
  ...
  Scenario Outline: DataEntityFieldName validation with invalid name in last element
    ...
    And log all MS response in console
    Then MS response code should be 400
    And MS JSON response string property key "errorMessage" should contain value "[Method not foundcom.temenos.microservice.paymentorder.entity.ExchangeRate.getPayeeType-com.temenos.microservice.paymentorder.entity.ExchangeRate.getPayeeType()]" 
    And MS JSON response string property key "errorCode" should equal value "[MSF-703]"
    And MS JSON response string property key "partyId" should equal value "[PO~DATEST~CADEST~USD~100]"
    And MS JSON response string property key "customerId" should equal value "[RG4]"
    And MS JSON response string property key "serviceId" should equal value "[PARTY]"
