...
export nodegroupname=ms-paymentordercluster-nodes
...
export postgresql_Connection_Url=jdbc:postgresql://po-postgresqldb-service.postgresql.svc.cluster.local:80/paymentorderdb
...
# Uncomment the below lines to run the postgresql db
# docker tag ms-paymentorder-postgres:latest $accountId.dkr.ecr.eu-west-2.amazonaws.com/$repositoryname:postgresql
# docker push $accountId.dkr.ecr.eu-west-2.amazonaws.com/$repositoryname:postgresql
...
helm install poappinit ./appinit -n poappinit --set env.appinit.databaseKey=postgresql --set env.appinit.databaseName=$database_Name --set env.appinit.dbUserName=$db_Username --set env.appinit.dbPassword=$db_Password --set image.appinit.repository=$appinitImageTag --set image.tag=$tag --set env.appinit.dbConnectionUrl=$postgresql_Connection_Url  --set env.appinit.dbautoupgrade="N"
