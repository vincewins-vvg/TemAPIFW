...
export AVRO_APP_NAME="paymentorderavroapp"
export EVENT_APP_NAME="paymentordereventapp"
...
# deploy appinit function app in to azure enviornment
if [ $SUBSCRIPTION_ID != "" ]; then
