...
public Object bundleOtherFieldValueWithRecordId(String recordId, String fieldName1 , String bundleName1, String fieldName2, String bundleName2, String ofsString1, String bundleValueInOFS, String ofsString2 ) {
     ...
     cucumberInteractionSession.scenarioBundle().put(recordId, idFromResponseContent);
